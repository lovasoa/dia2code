...
LicenseData COPYING
ComponentText "This will install dia2code 0.8.6 on your system. Select which options you want set up."
DirText "Select a directory to install the program in."
UninstallText "This will uninstall dia2code 0.8.6. Hit Next to uninstall, or Cancel to cancel."
OutFile dia2code-0.8.6-setup.exe
...
WriteRegStr HKEY_LOCAL_MACHINE "Software\Microsoft\Windows\CurrentVersion\Uninstall\dia2code" "DisplayName" "dia2code 0.8.6 (remove only)"
WriteRegStr HKEY_LOCAL_MACHINE "Software\Microsoft\Windows\CurrentVersion\Uninstall\dia2code" "UninstallString" '"$INSTDIR\uninstall-dia2code-0.8.6.exe"'
...
WriteUninstaller uninstall-dia2code-0.8.6.exe
...
SetOutPath $INSTDIR\bin
CreateShortCut "$SMPROGRAMS\dia2code\Uninstall dia2code 0.8.6.lnk" "$INSTDIR\uninstall-dia2code-0.8.6.exe" ""  "" 0
...
Delete $INSTDIR\uninstall-dia2code-0.8.6.exe
RMDir  $INSTDIR
