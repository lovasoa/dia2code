/***************************************************************************
          generate_code_as3.c  -  Function that generates Acrionscript 3.0 code
                             -------------------
...
int as3_vector_multiplicity(char *multiplicity) {
  if(0 == strlen(multiplicity) ||
     0 == strcmp("1", multiplicity) ||
     0 == strcmp("0..1", multiplicity)) return 1;
  return 2;
}
...
void generate_code_as3(batch *b)
{
    ...
    while ( tmplist != NULL )
    {
        ...
        if ( b->clobber )
        {
            ...
            {
              if(2 == as3_vector_multiplicity(associations->multiplicity)) {
